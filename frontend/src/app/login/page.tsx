        ...
        <div className="brand-side">
          <div className="logo-mark">
            <svg viewBox="0 0 60 60" width="80" height="80">
              ...
              <polygon points="30,5 55,50 30,40 5,50" fill="url(#logoGradient)" />
              <polygon points="30,20 45,50 30,42 15,50" fill="url(#logoGradient)" opacity="0.7" />
            </svg>
          </div>
      ...
      <div className="split-right">
        <div className="form-container">
          <form onSubmit={handleSubmit} className="login-form">
            <h2 style={{ marginBottom: 24, textAlign: 'center', fontWeight: 700 }}>Iniciar Sesión</h2>
            ...
            <div className="input-group">
              ...
              <div className="input-with-icon">
                <svg className="input-icon" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2">
